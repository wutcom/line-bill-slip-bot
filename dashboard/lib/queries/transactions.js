...
async function getTransactions({ userId, month, category, status, search, page = 1, pageSize = 25 } = {}) {
...
async function getTransactionCsv(filters = {}) {
...
function emptyTransactions(month, page, pageSize) {
  return {
    userId: null,
    month,
    page,
